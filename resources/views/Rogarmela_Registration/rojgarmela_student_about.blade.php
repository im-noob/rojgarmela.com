				...
				<div id="navbar" class="navbar-collapse collapse" data-spy="affix" data-offset-top="0">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown" class="caret"><a  class="page-scroll" class="dropdown-toggle" href="#" class="caret" data-toggle="dropdown">Student zone</a>
							<ul class="dropdown-menu" style="position: relative;background-color: black; color:white;width:200px;text-color:white;">
...
<section>
	<div style="position: relative;height: 600px;width:1200px;">
		<div id="notice" >
			<div style="position: relative;height: 500px;width:290px;background-color: white;left: 30px;top: 30px;">
			<h1 style="position: relative; text-align: center; top:40px;color: black;">Notification</h1>
		    <div class="container"  style="position: relative;top:190px;left: 90px;">
		...
		<div  id="about_us" ">
			<div style="position: relative;height: 500px;width:1090px;background-color:white;left: 30px;top: 30px;">
			<h1 style="position: relative; text-align: center; top:40px;color: black;">About us </h1>
