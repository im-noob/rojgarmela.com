...
@section('home')
                ...
                <div class="middle text-center clearfix">
                    <div class="container">
                        ...
                        <a href="#contact" target="_blank" class="btn btn-lg btn-hire wow animated zoomIn">Apply Now</a>
                    </div>  <!-- container -->
                </div>  <!-- middle -->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 wow animated fadeInRight">
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-info">
                                            <div class="clearfix">
                                                ...
                                                <p class="btn btn-success" type="button" data-toggle="modal" data-target="#thismodal"><strong> Address:</strong> Bhagalpur,, Tatarpur, Bhagalpur, Bihar 812002.
                                                </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                ...
                                                <p><strong> Cell No:</strong> +91-9523-9083-98 </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                    <div class="sqaure-nebir"></div>
                                ...
                                <div class="row">
                                    <ul class="social-box">
                                        <li><a class="facebook-icon" href="https://www.facebook.com/viim08feb2016/"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d28870.985847550248!2d86.9597266!3d25.2411944!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbea11dff068ef166!2sVardayani+Institute+of+IT+and+Management!5e0!3m2!1sen!2sin!4v1515651489687" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe></p>
                </div>
